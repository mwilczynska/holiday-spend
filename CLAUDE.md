...
- [x] Verify official websites for eleven of Barcelona's twelve 4-star primary properties; resolve the legacy rank-7 identity through its matching registration id, retain rank 4 as unresolved, and do not count website verification as quote evidence
...
- Barcelona's 4-star primary panel now has eleven source-attributed official websites applied through a validated deterministic artifact; Marriott's current page resolves the legacy Husa L'Illa identity through registration `HB-003973`, Sansi Pedralbes (rank 4) remains unresolved, and no website verification is counted as price or quote evidence
