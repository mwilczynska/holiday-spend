...
002, 003, 004 and 005 added 50 cities, so 70/121 are staged and 51 remain. Batches 001 and 002 each had one all-prior
candidate at 10%; batch 003 had two (Santa Fe (Bantayan) and Siargao, 20%); batch 004 had none; batch 005 had one
(Aomori, 10%). All remain below the batch stop rule. Batch 004 had 0/10 direct drink categories, which is carried as
an operational Phase 10 finding; batch 005 had 4/10 direct drink categories. The next exact action is fixed delegated
batch 006. The live CSV and
...
persistence/API provenance equality. Phase 8 is complete and Phase 9 is active at 70/121 staged; batch 006 is next.
...
the hashed experiment-014 pass. The exact next action is fixed delegated migration batch 006 through the completed
