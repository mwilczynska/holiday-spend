...
- [x] Generate a deterministic 36-city candidate pilot spanning every region and the current cost range
  ...
  - [x] Complete the UN WUP population matching pass with 29 reviewed records and seven explicit unmatched/non-single-city outcomes; reject fuzzy substitutes and keep all 36 tourism fields pending
