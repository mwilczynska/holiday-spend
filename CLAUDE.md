...
| Retired v6.1 research history | `docs/dev/plans/city-cost-methodology-v6-1.md`, `data/reference/v6/` |
...
v6/v6.1 are rejected product approaches retained for audit and reproducibility under `data/reference/v6/` and the
archived `feat/city-cost-methodology-v6` branch. Their experiments, spent holdouts, staged CSV, canary records,
and impact reports are historical evidence. Do not resume their collection, open holdouts, import staged rows, run
Phase 11, or enable their old three-call/search contract.
...
| `data/reference/v6/` | Retained v6 research evidence; not a current product path |
