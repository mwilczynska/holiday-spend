...
002, 003, 004, 005 and 006 added 60 cities, so 80/121 are staged and 41 remain. Batches 001 and 002 each had one
all-prior candidate at 10%; batch 003 had two (Santa Fe (Bantayan) and Siargao, 20%); batch 004 had none; batch 005
had one (Aomori, 10%); batch 006 had one (Hong Kong, 10%). All remain below the batch stop rule. Batch 004 had 0/10
direct drink categories, which is carried as an operational Phase 10 finding; batch 005 had 4/10 and batch 006 had
2/10 direct drink categories. The next exact action is fixed delegated batch 007. The live CSV and
...
persistence/API provenance equality. Phase 8 is complete and Phase 9 is active at 80/121 staged; batch 007 is next.
...
the hashed experiment-014 pass. The exact next action is fixed delegated migration batch 007 through the completed
