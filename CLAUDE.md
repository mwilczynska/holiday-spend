...
- [ ] Complete comparable tourism intensity using same-geography overnight arrivals and resident population
  - [x] Measure tourism intensity for 13/36 cities and both registered predictors for 12/36
  - [x] Screen nine of the 23 unmeasured cities and retain explicit rejections where official series do not match the registered numerator
  - [ ] Screen or measure the remaining 14 unscreened cities without accepting geography or estimand mismatches
