...
- [ ] Complete comparable tourism intensity using same-geography overnight arrivals and resident population
  ...
  - [x] Screen eight of the 23 unmeasured cities and retain explicit rejections where official series do not match the registered numerator
  - [ ] Screen or measure the remaining 15 unscreened cities without accepting geography or estimand mismatches
