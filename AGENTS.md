...
- [ ] Complete comparable tourism intensity using same-geography overnight arrivals and resident population
  - [x] Measure tourism intensity for 14/36 cities and both registered predictors for 12/36
  - [x] Screen 12 of the 22 unmeasured cities and retain explicit rejections where official series do not match the registered numerator
  - [ ] Screen or measure the remaining ten unscreened cities without accepting geography or estimand mismatches
