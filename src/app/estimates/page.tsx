...
const METHODOLOGY_SECTIONS: MethodologySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'These are sampling milestones, not price or accuracy results. Across Barcelona and Copenhagen, no official property website has yet passed verification and no accommodation quote has been accepted. Source-listed links, eligibility, price observation, and validation evidence are deliberately separate states.',
    ],
    bullets: [
      ...
      'Current frozen frames: Barcelona plus Copenhagen hotel classes; Copenhagen hostel candidate universe pending inventory/location checks',
