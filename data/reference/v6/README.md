...
construct priors. The retained proposal `ground-truth/fresh-holdout-proposal-v2.json` records verified BYT
page existence and a 72/90 minimum coverage gate, but it contains no values and is cancelled for v6.1.
