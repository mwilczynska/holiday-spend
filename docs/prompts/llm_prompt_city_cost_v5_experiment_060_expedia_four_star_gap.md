# v5 Experiment 060 - Expedia four-star gap panel
...
`site:expedia.com {{CITY}} {{COUNTRY}} 4-star hotels average nightly price trend 2 adults taxes fees`
...
Accept only an Expedia result that explicitly identifies the exact city and 4-star class, states a numeric non-from
...
```json
{
  "schemaVersion": "city-cost-v5-expedia-four-star-gap-v1",
  "city": "{{CITY}}",
  "country": "{{COUNTRY}}",
...
Do not add commentary outside JSON. A found row remains source-feasibility evidence only and cannot amend the
Experiment 059 gate or authorize product mapping/model fitting.
