...
| `llm_prompt_city_cost_v6_numbeo.md` | **ACTIVE — v6 M1** | `src/lib/city-cost-v6-collection.ts` | Search-snippet extractor for five Numbeo food/drink anchors; source currency only |
| `llm_prompt_city_cost_v6_expedia_3star.md` | **ACTIVE — v6 M1** | `src/lib/city-cost-v6-collection.ts` | Search-snippet extractor for the Expedia three-star accommodation level |
| `llm_prompt_city_cost_v6_budgetyourtrip.md` | **ACTIVE — v6 M1** | `src/lib/city-cost-v6-collection.ts` | Search-snippet extractor for three BudgetYourTrip activity proxies |
