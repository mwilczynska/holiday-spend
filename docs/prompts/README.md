...
| `llm_prompt_city_cost_v6_numbeo.md` | **HISTORICAL — v6.0 compatibility only** | archived v6 parser | Retained for stored-response replay; never collect new data |
| `llm_prompt_city_cost_v6_expedia_3star.md` | **HISTORICAL — v6.0 compatibility only** | archived v6 parser | Retained for stored-response replay; never collect new data |
| `llm_prompt_city_cost_v6_budgetyourtrip.md` | **HISTORICAL — v6.0 compatibility only** | archived v6 parser | Retained for stored-response replay; never collect new data |
| `llm_prompt_city_cost_v6_1_expedia_3star.md` | **HISTORICAL — v6.1** | archived v6 evidence | Rejected three-call contract; do not run |
| `llm_prompt_city_cost_v6_1_budgetyourtrip_daily_tiers.md` | **HISTORICAL — v6.1** | archived v6 evidence | Rejected source-native contract; do not run |
| `llm_prompt_city_cost_v6_1_numbeo_drinks.md` | **HISTORICAL — v6.1** | archived v6 evidence | Rejected drink contract; do not run |
