...
| `llm_prompt_city_cost_v5_experiment_087_expedia_locale_proxy_broad_panel.md` | **EXPERIMENT — in progress** | one city per delegated GPT-5.6 Luna-class invocation | Broad 24-city 2–4-star locale-proxy coverage panel; pooled matched-city gate remains evidence-only |
