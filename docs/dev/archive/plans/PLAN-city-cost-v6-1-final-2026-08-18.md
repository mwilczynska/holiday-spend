> **SUPERSEDED — not current.** This is the former project plan retained as historical record. It was replaced by the v1.1 simplification plan in the root `PLAN.md` on 18 August 2026. The v6.1 branch and its research evidence remain preserved in Git history; do not resume its Phase 11 cutover.
...
tooling is complete, and Phase 9 has staged 110/121 cities in batches 001–009. Batch 009 remained below the artifact
stop rule (Reykjavik was the only all-prior candidate, 10%); 11 cities remain. The exact next action is fixed delegated
batch 010, followed by the complete verification baseline. The live CSV, holdouts and Phase 11 remain untouched.
