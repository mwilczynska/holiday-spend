...
first seven pilot-wave checkpoints contain 135 direct observations across 27 cities, representing every
pilot region: 104 standardized Numbeo food/drink prices, one Pu Luong official-menu meal, 24 official
...
The validator reports 135 valid direct rows
...
The current materialized artifact contains 27 cities and 135 accepted direct observations. It can
calculate 130 of 513 possible city-tier cells: coffee and the coffee-only/light drinks baskets for 26
cities, free activities for all 27, budget paid-attraction baskets for 24, and one Pu Luong mid-range
