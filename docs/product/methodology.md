...
first eight pilot-wave checkpoints contain 149 direct observations across 30 cities, representing every
pilot region: 116 standardized Numbeo food/drink prices, one Pu Luong official-menu meal, 26 official
...
The validator reports 149 valid direct rows
...
The current materialized artifact contains 30 cities and 149 accepted direct observations. It can
calculate 144 of 570 possible city-tier cells: coffee and the coffee-only/light drinks baskets for 29
cities, free activities for all 30, budget paid-attraction baskets for 26, and one Pu Luong mid-range
